...
$(function(){
   ...
   $(".mini").click(function(){
	 ...
	 $("#saledate").change(function(){
		...
		var month = dtNextWeek.getMonth()+parseInt(1);
		if(month < 9)
		{
			month = '0'+month;
		}
		...
		$("#addsample").click(function(){
			$.ajax({ 
								...
								success: function(mdata){
									...
									{
									    count = parseInt($("#samplecount").val()) ;
									}
									var finalc = parseInt(count) + parseInt(1);
		...
		if(countsample>0)
		{
			...
			$('input[name^="packtvalue"]').each(function() {
				...
				else
				{
   				 ...
   				 samplednet = parseInt(samplednet) + parseInt(value);
				
			});
			weight =  parseInt(packged) +  parseInt(samplednet);
		}
		else
		{
			weight = package * net;
	...
	function calculatetotal()
	{
		...
		var total = parseInt(value)+parseInt(brokerage)+parseInt(vat)+parseInt(servicetax);
		return (total);
	...
	function calculateTeavalue()
	{
		...
		$('input[name^="detailvalue"]').each(function() {
				...
				else
				{
   				 ...
   				 totalnet = parseInt(totalnet) + parseInt(value);
			});
	...
	function calculateTotalBrokerage()
	{
		...
		$('.listbrok').each(function() {
				...
				else
				{
   				...
   				totalbrok = parseInt(totalbrok) + parseInt(value);
			});
	...
	/*function calculateTotalServiceTax()
	{
		...
		$('.listbrok').each(function() {
				...
				else
				{
   				 ...
   				 totallistbrok = parseInt(totallistbrok) + parseInt(value);
			});
	...
	/*function calculateTotalVatrate()
	{
		...
		//{
			...
			var value = (parseInt(teavalue) +  parseInt(totalbrokerage) + parseInt(allowance)) * vat;
	...
	function claculeteTotalPurchaseInvoice()
	{
		...
		var totalcalculation = parseInt(teavalue) + parseInt(brokerage)   + parseInt(servicetax)  + parseInt(chestallow)  + parseInt(calculatevat) + parseInt(stampcharge);
