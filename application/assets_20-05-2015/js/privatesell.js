				...
				"Confirm": function() {
					...
					var sample = "<table><tr><td>"+
						...
						$("#detailtr"+rowid).html(
							...
							"<td>"+"<span id='lot"+rowid+"'>"+$('#lot').val()+"</span><input type='hidden' name='detailtableid[]' value='"+$('#detailtableid'+rowid).val()+"' /><input type='hidden' name='detaillot[]' value='"+$('#lot').val()+"'/><br/><span id='do"+rowid+"'>"+$('#do').val()+"</span><input type='hidden' name='detaildo[]' value='"+$('#do').val()+"' /></td>"+
