<?php
class customerpaymentotheradj extends CI_Controller {
    ...
    public function index(){
        ...
        if ($this->session->userdata('logged_in')) {
            $result = $this->customerpaymentmodel->getCustomerOtherAdjPaymentList($session['company'],$session['yearid']);
            //$result="";
            $page = 'customer_payment/list_viewOtherAdj';
            $header = '';
        ...
        if ($this->session->userdata('logged_in')) {
          ...
          /*  $headercontent['CashOrBank'] = $this->generalvouchermodel->getAccountByGroupMaster($session['company']);*/
            ...
            if ($customerpaymentId == 0) {
                ...
                $page = 'customer_payment/addEditOtherAdj';
                $result = "";
            } else {
   ...
   public function saveCustomerPayment() {
        ...
        if ($this->session->userdata('logged_in')) {
            ...
            $masterData["transaction_type"] = 'RJV';
