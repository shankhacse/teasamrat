 ...
 // modified on 06.04.2018 by shankha
   public function checkExistPurchaseInvoice(){
       // $data="0";
        ...
        $purchaseInvoice = htmlspecialchars(trim($this->input->post('purchaseInvoiceNo')));
        $vendor = htmlspecialchars(trim($this->input->post('vendor')));
        $year = $session['yearid'];

         $result = $this->purchaseinvoicemastermodel->checkExistingInvoice($purchaseInvoice,$vendor,$year);
         if($result==TRUE){
             echo "1";
         }
         else{
