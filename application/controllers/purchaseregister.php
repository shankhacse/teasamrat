     ...
     public function index() {
        ...
        if ($this->session->userdata('logged_in')) {
           ...
           // $session_purchase = $this->session->userdata('purchase_invoice_list_detail');
            ...
            $headercontent['fiscalStartDt'] = $this->purchaseinvoicemastermodel->getFiscalStartDt($yearid);
            $headercontent['fiscalEndDt'] = $this->purchaseinvoicemastermodel->getFiscalEndDt($yearid);
