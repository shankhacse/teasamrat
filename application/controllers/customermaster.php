...
class Customermaster extends CI_Controller {
 ...
 public function getCustomerList(){
     ...
     $result= $this->customermastermodel->getAutoCompltCustomer($term,$compny);
...
public function nameExist()
{
    ...
    $customer=  $this->input->post('cName');
    $res = $this->customermastermodel->getCustomerExist(trim($customer),$compny);
    echo $res;
