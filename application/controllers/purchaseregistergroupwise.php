<?php
    ...
    public function getPurchaseRegisterPrintGroupWise(){
       ...
       $value = array(
		...
		$result['fromDt'] = $startdate;
		$result['endDate'] = $enddate;
       // $result['search_purchase_register'] = $this->purchaseinvoicemastermodel->getPurchaseRegister($value);
	   
		if(trim($billType=="GST"))
		{
		   $result['search_purchase_register'] = $this->purchaseregistermodel->getPurchaseRegisterGSTGroupWise($value);
		   /*
		   echo "<pre>";
		   print_r($result['search_purchase_register']);
		   echo "</pre>";
		   */
		   $page = 'purchase_register/purchase_reg_groupwise/purchase_reg_groupwise_gst_pdf.php';
		}
		else
		{
