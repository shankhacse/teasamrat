         ...
         if ($this->session->userdata('logged_in')) {
            ...
            if($customerAdvanceAdjustment!=0){
                 $user_activity_data =  array(
                                    ...
                                    "activity_module" => "Customer Adjustment ",
                                    "action" => "Delete",
                                    "narration" => " deleted ID is ".$customerAdvanceAdjustment,
                                    "from_method" => "customeradvance/delCustomerAdvance",
                                    "user_id" => $session['user_id']
                                 );
                $rslt = $this->customeradvanceadjstmentmodel->delete($customerAdvanceAdjustment,$user_activity_data);
            }
