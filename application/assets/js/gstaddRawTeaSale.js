...
// raw tea sale gst
function delRawTeaSaleBillGST(id,salebillno)
{
    ...
    $("#dialog-confirm-salebill").dialog({
        ...
        buttons: {
            "Ok": function() {
                ...
                $("#delrawsalebill_gst").css("display","none");

                $.ajax({
                    type: 'POST',
                    url: basepath + "gstrawteasale/delRawTeaSaleBillGST",
                    data:{"salebillID":id,"salebillno":salebillno},
                    dataType:'json',
                    contentType: "application/x-www-form-urlencoded; charset=UTF-8", 
                    success: function(data) 
                    {
                        $("#rawteaSaleResponse").modal({"backdrop"  : "static",
                              "keyboard"  : true,
                              "show"      : true                    
                        });
                        ...
                        if(data.ERROR==1)
                        {
                            ...
                            $("#rawteaSaleResponseData").html(errMsg );
                            $(".sb_body").css({
                                'background':'#ff5050',
                                'color':'#FFF'
                            });
                            ...
                            $("#delrawsalebill_gst").css("display","inline-block");
                        }
                        if(data.ERROR==2)
                        {
                            $("#rawteaSaleResponseData").text(data.MSG);
                            $(".sb_body").css({
                                'background':'#ff5050',
                                'color':'#FFF'
                            });
