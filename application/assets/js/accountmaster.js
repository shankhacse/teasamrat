...
$(function(){
   ...
   $("#edit").click(function(){
	...
	//	alert($("#mode").val());
		var groupID = $("#groupid"+selectedVal).val();
		$("#group_id_val").val(groupID);
		...
		if(groupID==1 || groupID==2){
			...
			// 1 = Sundry Debtors
			// 2 = Sundry Creditors
			var grpname = $("#groupnametxt"+selectedVal).val();
			$("#groupnameTxt").text(grpname);
		...
		$("#balance").val($.trim($('#openbal'+selectedVal).html()));
		...
		$('#adddiv').show('slow', function() {  });
			...
			$("#update").click(function(){
			   ...
			   var name = $("#name" ).val();
			   var grp_id_val = $("#group_id_val").val();
			   if(grp_id_val==1 || grp_id_val==2){
				   var groupname =  grp_id_val;
			   }
			   else{
...
function validateAccountFrm()
{
	...
	var groupidval = $("#group_id_val").val();
