 ...
 $('.payment').keypress(function(event){
   ...
   $("#billAdjustTable").on('click', '.rowDel', function () {
        ...
        if(conf)
        {
            ...
            deleteDetailData(basepath,vendorbillmasterID,'VPAYMENT');
            enableVendor();
...
function deleteDetailData(basepath,vendorbillmasterID,from)
{
    $.ajax({
            url: basepath + 'vendorpayment/deleteDetailData',
            data: {vendorbillmasterID:vendorbillmasterID,from:from},
            type: "POST",
            dataType: "json",
            success: function (data) {
