...
$(document).ready(function () {
 ...
 $("#customer,#cashorbank").customselect();
 ...
 $('.txtamounttobecredited').keypress(function(event){
       ...
       $.ajax({
            ...
            success: function(data){
              if(data==1){
                  ...
                  {
                    $("#chequedt").val($("#dateofadvance").val());
                  }
    ...
    $("#customer").change(function () {
        ...
        $.ajax({
            url: basepath + 'customerpaymentotheradj/getSaleBillList',
            data: {
    ...
    //getting bill details
     $(document).on('change','#saleBill',function(){
      ...
      $.ajax({
        url: basepath+'customerpaymentotheradj/getUnpaidtBillAmount',
...
$("#saveCustomerPayment").click(function(){
   ...
   var customerPaymentId = $("#customerPaymentId").val()||0;
    if(validation()){
        ...
        $.ajax({
                type: 'POST',
                url: basepath + "customerpaymentotheradj/saveCustomerPayment",
                data: {
                ...
                success: function (data) {
                    ...
                    if (data.msg==1) {
                        ...
                        //to do
                           window.location.href = basepath + 'customerpaymentotheradj';
                    }
                    else {
