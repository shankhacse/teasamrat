 ...
 function updateTransDo(transpoId,Serial){
	...
	var do_date = $(jdo_date).val();
        ...
        if(getValidation(transpoId,Serial)){
            ...
            $("#updaterow_"+serialId).css("display","none");
             $("#update-loader_"+serialId).css("display","block");
    ...
    $.ajax({
        ...
        success: function(data) {
            if(data==1){
               $("#updaterow_"+serialId).css("display","block");
               $("#update-loader_"+serialId).css("display","none");
