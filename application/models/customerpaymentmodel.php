...
class customerpaymentmodel extends CI_Model {
    ...
    private function insertVoucherMaster($masterData) {
        ...
        $voucherMasterArray["transaction_type"] = $masterData["transaction_type"]; // 
    ...
    public function getCustomerPaymentList($compy,$year){
        ...
        $sql= "SELECT
                ...
                WHERE voucher_master.transaction_type <> 'RJV' 
                AND voucher_master.`company_id`=".$compy." AND voucher_master.`year_id`=".$year;
     ...
     public function getCustomerOtherAdjPaymentList($compy,$year){
    ...
    public function insertIntoUserActivity($insertArr)
    {
     ...
     public function deleteCustomerPaymentDtl($customerreceiptdtlId,$customerBillMasterId)
    {

         $where = array(
            "customerreceiptdetail.`id`"=>$customerreceiptdtlId,
            "customerreceiptdetail.`customerbillmasterid`"=>$customerBillMasterId
       ...
       try 
        {
            ...
            // delete customerbillpaymentdetail
            $this->db->where($where);
            $this->db->delete('customerreceiptdetail'); 
            #echo $this->db->last_query();
            if ($this->db->trans_status() === FALSE) 
