...
class gsttaxinvoicemodel extends CI_Model {
    ...
    /*    $sql ="SELECT
		...
		$sql = "SELECT
				 ...
				 sale_bill_details.`delivery_charge`,
 ...
 $sql= "SELECT
            ...
            totalCGST,  totalSGST,  totalIGST,  IsGST,consignee_id
           ...
           $saleBillMaster = array();
            ...
            if (isset($searcharray['sel_consignee'])) {
                if ($searcharray['sel_consignee']=="") {
                    $saleBillMaster['consignee_id']=NULL;
                }else{
                     $saleBillMaster['consignee_id']=$searcharray['sel_consignee'];
                }
            }
...
public function getConsigneeByCustomerId($customerid,$companyid)
    {   $data=[];
        $where = array(
            
            "consignee_master.`customer_id`"=>$customerid,
...
public function getConsigneeByConsignId($consigneeid)
    {   $data=[];
        $where = array(
