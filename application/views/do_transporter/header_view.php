                                            ...
                                            <tr>
                                                ...
                                                <td style="font-size:12px">
                                                 ...
                                                 <td>
                                                     ...
                                                     id='updaterow_<?php echo($sl);?>' 
                                                            onclick="updateTransDo(<?php echo(($content->dotransportaionid==''?"''":$content->dotransportaionid));?>,<?php echo($sl);?>);" />
                                      
                                                     <div id="update-loader_<?php echo $sl;?>" style="display:none; text-align: center;margin-right: 15px;">
                                                  <img src="<?php echo base_url(); ?>application/assets/images/lg.recycle-spinner.gif" style="height: 25px;width: 25px;" />
