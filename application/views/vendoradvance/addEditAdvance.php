            ...
            <tr>
                ...
                <td>
                  <?php if($header['mode']=="Edit"){?>
                    <input type="hidden" id="hidenChqno" class="textStyle" value="<?php echo($bodycontent['vendoradvancement']['cheque_number']);?>"/>
                    <input type="hidden" id="hidenChqdate" class="textStyle" value="<?php echo($bodycontent['vendoradvancement']['cheque_date']);?>"/>
