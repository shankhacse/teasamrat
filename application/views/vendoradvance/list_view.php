        ...
        <tr>
            ...
            <td>
				...
				<?php } ?>
                  ...
                  <img src="<?php echo base_url(); ?>application/assets/images/delete.png" id="del_va_Icon" title="" alt="" width="20" height="20" onclick="delVendorAdvance(<?php echo ($content['advanceId']); ?>,'<?php echo $content['voucher_number']; ?>')" />
                </a>
            </td>
...
<div class="modal fade" id="vendoradvanceResponse" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body va_body" id="vendoradvanceResponseData" style="font-family: verdana;font-size:17px;">
        
      </div>
      <div class="modal-footer va_footer" id="" style="">
        <button type="button" class="btn btn-secondary va_btn" data-dismiss="modal"  id="va_close_btn">Close</button>
      </div>
    </div>
  </div>
</div>