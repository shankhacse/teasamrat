                                           ...
                                           ?>
                                            <tr>
                                                ...
                                                <td>
                                                  ...
                                                  <td>
                                                    <input type="text" id="SaleHSNId_<?php echo($content['productPacketId']);?>" class="hsncode"
                                                       style="background-color : #EEEEEE;border: 1px solid #008000;width: 100px;border-radius:5px; text-align: left;"    
                                                       value="<?php echo($content['hsncode']);?>"/>
                                                </td>
