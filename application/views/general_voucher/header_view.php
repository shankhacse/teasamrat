  ...
  <tr style="display:none;">
   ...
   <tr>
       ...
       <td><input type="text" name="voucherDate" id="voucherDate" class="datepicker textStyle" value="<?php //echo $bodycontent['generalVouchermaster']['voucher_date'];
        if($bodycontent['generalVouchermaster']['voucher_date']){echo $bodycontent['generalVouchermaster']['voucher_date'];}else{echo $entryDt;}
       ?>" readonly /></td>
   ...
   <tr>
       ...
       <td>
          ...
          { ?>
                <input type="hidden" value="<?php echo $entryDt;?>" id="hidenChqdate" />
              <input type="text" name="chqDate" id="chqDate" value="<?php echo $entryDt;?>" class="datepicker textStyle" 
                  <?php if($bodycontent['generalVouchermaster']['groupname']=="Cash Balance"){echo "disabled";}else{"";}?>
                  readonly />
          <?php
          } 
...
<div id="save_voucher_detail_data"  style="display:none" title="generalVoucher">
 ...
 data-dismiss="modal" onclick="redirectMe('<?php echo base_url()?>','generalvoucher');" >Close</button>
</div>
<!--
...
<!-- Modal -->
<div id="saveMsgModal" class="modal fade" role="dialog" style="margin-top: 200px;">
  <div class="modal-dialog modal-sm">
    ...
    <?php if($modeType=="Edit"){ ?>
<button type="button" style="margin-right: 90px;" class="btn btn-default" data-dismiss="modal" onclick="redirectMe('<?php echo base_url()?>','generalvoucher/print_item/voucherId/10033').value);" >Print Voucher</button>
       <button type="button" class="btn btn-default" data-dismiss="modal" onclick="redirectMe('<?php echo base_url()?>','generalvoucher');">Close</button>
    <input type="hidden" name="voucher_mst_id" id="voucher_mst_id" value="10033" >
    <?php }else{ ?>
  
    <button type="button" style="margin-right: 90px;" class="btn btn-default" data-dismiss="modal" onclick="redirectMe('<?php echo base_url()?>','generalvoucher/print_item/'+ document.getElementById('voucher_mst_id').value);" >Print Voucher</button>
     <button type="button" class="btn btn-default" data-dismiss="modal" onclick="redirectMe('<?php echo base_url()?>','generalvoucher');">Close</button>
    <?php } ?>
      </div>
    </div>
