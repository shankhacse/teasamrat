...
<table width="100%" border="0">
  <tr style="display:none;">
   ...
   <tr>
       ...
       if($bodycontent['contraVouchermaster']['voucher_date']){echo $bodycontent['contraVouchermaster']['voucher_date'];}else{echo $entryDt;}
       ?>"  readonly /></td>
   ...
   <tr>
       ...
       <td>
        <?php if($header['mode']=="Edit"){?>
          <input type="text" name="chqDate" id="chqDate" value="<?php echo $bodycontent['contraVouchermaster']['cheque_date'];?>" class="datepicker textStyle" readonly />
        <?php }else{ ?>
...
<div id="save_voucher_detail_data"  style="display:none" title="contraVoucher">
 ...
 data-dismiss="modal" onclick="redirectMe('<?php echo base_url()?>','contravoucher');" >Close</button>
</div>
