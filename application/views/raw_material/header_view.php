      ...
      <input type="hidden" id="txtModeOfoperation" name="txtModeOfoperation" value="<?php echo($header['mode']); ?>"/>
        ...
        <table width="100%">
            <tr>
                ...
                <td>&nbsp;</td>
                <td>
                    <select id="type" class="selectStyle" name="type" style="width:200px;">
            ...
            <tr>
                ...
                <td>:&nbsp;&nbsp;</td>
                <td>
                    <select name="unitid" id="unitid" style="width:200px;" class="selectStyle" <?php if($bodycontent['rawmaterial']['type']== "S"){echo('disabled');}else{echo('');} ?>>
            ...
            <tr>
                ...
                <td> 
                    ...
                    <!-- <input type="text" id="rate" name="rate" value="<?php echo $bodycontent['rawmaterial']['purchase_rate'];?>" /> -->
                </td>
            </tr>
             <tr>
                <td>&nbsp;</td>
             ...
             <tr>
                ...
                <td> 
                    ...
                    <input type="text" id="rate" name="rate" class="textStylesmall" value="<?php echo $bodycontent['rawmaterial']['purchase_rate'];?>" />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>:&nbsp;&nbsp;</td>
                <td> 
                    <input type="text" id="hsncode" name="hsncode" class="textStylesmall" value="<?php echo $bodycontent['rawmaterial']['hsncode'];?>"  />
                </td>
            </tr>
