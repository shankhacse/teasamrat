				...
				<table width="100%" class="" >
					...
					<tr>
					 ...
					 -->
						...
						<?php 
							if($headerview['consignee_id']!=NULL){

					?>
					<tr>
						<td>Name</td>
						<td><?php echo $consigndtl->consignee_name;?></td>
					</tr>
					<tr>
						<td>Address </td>
						<td><?php echo $consigndtl->address;?></td>
					</tr>
					<tr>
						<td>State </td>
						<td><?php echo $consigndtl->state_name;?></td> 
					</tr>
					<tr>
						<td>State Code </td>
						<td><?php echo $consigndtl->state_code;?></td>
					</tr>
					 <tr>
						<td>GISTIN/Unique ID </td>
						<td><?php echo $consigndtl->gstin;?></td>
					</tr>
...
<?php 
	...
	$totalDeliveryCharge+= $value['delivery_charge'];
...
<tr>
                ...
                <td align="left"><?php echo($value['lot']);?></td>
               ...
               <!-- <td align="right"><?php echo($value['cost_of_tea']);?></td>-->
                ...
                <td align="right"><?php echo number_format(($value['delivery_charge']),2);?></td>
...
<?php } ?>
        ...
        <tr>
            <th colspan="7" align="left"><?php echo "Total"; ?></th>
            ...
            <th align="right"><?php echo number_format($totalDeliveryCharge,2); ?></th>
...
<table width="100%" class="headerdemo" border="0" style="border-top:0;font-size:11px;" cellspacing="8" cellpadding="0">
	...
	<tr style="height:25px;">
		<td width="50%">Declaration :
		<br><br>
			We declare that this invoice shows the actual price of the goods described and that all particulars are true and correct.
			
			<br><br><br>
			
			<?php echo $headerview['company_name']; ?><br>
			<?php echo $headerview['bank_name']; ?> A/C NO - <?php echo $headerview['bank_ac_no']; ?><br>
			IFSC CODE - <?php echo $headerview['ifsc_code']; ?><br>
			BRANCH - <?php echo $headerview['bank_branch_add']; ?>
		
		</td>
		<td width="50%">Signature
			<br><br>Name of the Signatory
			<br><br>Designation / Status
		</td>
	</tr>
	<!--
	<tr>
		<td width="50%">We declare that this invoice shows the actual price of the goods described and that all particulars are true and correct.
		<br><br><br>
		
		TEA SAMRAT<br>
		HDFC BANK A/C NO - 50200007909497<br>
		IFSC CODE - HDFC0000040<br>
		BRANCH - NEW ALIPORE, KOLKATA -700053 
		</td>
