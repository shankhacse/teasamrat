<script src="<?php echo base_url(); ?>application/assets/js/RawTeaSaleEditJs.js"></script> 
         ...
         foreach ($bodycontent['rawteasaleDtlData'] as $rows) { 
          ...
          ?>
            <tr class="<?php echo $tr_style; ?>">
                ...
                <td align="center">
                    <input type="text" id="hdTxtBlended_<?php echo($rows['PbagDtlId']); ?>" name="txtBlendBag" value="<?php echo($rows['saleBagNo']); ?>"/>
                    <input type="text" id="txtused_<?php echo($rows['PbagDtlId']); ?>" name="txtused[]" class="usedBag" 
                           style="background-color : #EEEEEE;border: 1px solid #008000;width: 50px;border-radius:5px; text-align: right;" value="<?php echo($rows['saleBagNo']); ?>" />
                </td>
