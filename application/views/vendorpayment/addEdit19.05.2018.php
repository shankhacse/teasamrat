     ...
     <thead style="background-color:gray;">
      ...
      foreach ($bodycontent["vendorPaymentDtl"] as $value) {
            ?>
              ...
              <img src='<?php echo base_url(); ?>application/assets/images/delete-ab.png' alt='del' data-vendorbillmastid="<?php echo($value["vendorBillMaster"]); ?>" class='rowDel' style='cursor: pointer;' /></td>
              </tr>
