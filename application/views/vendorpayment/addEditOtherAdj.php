<script src="<?php echo base_url(); ?>application/assets/js/vendorpaymentOtherAdjAdd.js"></script>
...
<div class="stats">
   <p class="stat">
        <a href="<?php echo base_url(); ?>vendorpaymentotheradj">
...
<h2><font color="#5cb85c">Add vendor's Bill Adj( TDS / Delivery...)</font></h2>
<?php }else{?>
<h2><font color="#5cb85c">Edit vendor's Bill Adj( TDS / Delivery...)</font></h2>
<?php } ?>
...
<section id="loginBox" style="height: 300px;">
  ...
  <tr>
    <td><!--Cash/Bank.&nbsp;--> A/C to be credited&nbsp;</td>
    <td>
        <select id="cashorbank" name="cashorbank" class="selectStyle custom-select">
  ...
  <tr>
    ...
    <td>
      ...
      <input type="text" id="chequeno"  value="<?php echo($bodycontent['vendorpayment']['cheque_number']); ?>" />
      <input type="text" id="chequedt"  value="<?php echo($bodycontent['vendorpayment']['cheque_date']); ?>" />
  ...
  <tr>
    <td style="vertical-align:top;">Narration&nbsp;</td>
    <td ><textarea id="narration" name="narration" class="textStyle" cols="18"><?php echo($bodycontent['vendorpayment']['narration']); ?></textarea></td>
