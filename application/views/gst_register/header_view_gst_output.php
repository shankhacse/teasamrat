...
<h1 style="font-size:26px;"><font color="#5cb85c">GST Register(Output)</font></h1>

 <div id="adddiv">
 <form id="frmGstRegisteroutput" method="post" action="<?php echo base_url(); ?>gstregister/getGSTRegisterOutput"  target="_blank">
...
-->
  <span class="buttondiv"><div class="save" id="gstRegisteroutputPDF" align="center">Pdf</div></span>
  </section>
