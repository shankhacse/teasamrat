...
<?php $uptoReportDt = getReportDate(); ?>
 <div id="adddiv">
  ...
  <section id="loginBox" style="width:600px;border-radius:10px;">
      <form id="generalledgerreport" name="generalledgerreport" method="post" action="<?php echo base_url(); ?>generalledgerreport/pdfGeneralLedgerType2"  target="_blank">
      <table width="90%" align="center">
		  ...
		  <tr>
               ...
               <td>:&nbsp;</td>
               <td>
                    <select id="reportType" name="reportType"  class="form_style">
