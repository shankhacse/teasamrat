...
<table width="100%" align="center" style="margin-top:0;">
    <tr>
        ...
        <td align="right" style="font-size:12px;font-weight:bold;font-family:verdana;"><?php echo "Print Dt. ".date('m-d-Y')?></td>
    </tr>
...
<div style="padding-top:10px;"></div>
        <table class="tg" width="100%">
            <tr>
                ...
                <th class="tg-ir9v" align="left">Stock-Op</th>
                <th class="tg-ir9v" align="right">Stock-In</th>
                <th class="tg-ir9v" align="right">Stock-Out</th>
                <th class="tg-ir9v" align="right">Balance</th>
                <th class="tg-ir9v" align="right">Rate/kg.</th>
                <th class="tg-ir9v" align="right">Net in kgs.</th>
                <th class="tg-ir9v" align="right">Valuation</th>
            </tr>
            <?php
            foreach ($finishProdStock as $content) {
                ...
                <tr>
                    ...
                    <td class="tg-yw4l" style="text-align: right;"><?php echo($content["stockopening"]); ?></td>
                    ...
                    <td class="tg-yw4l" style="text-align: right;"><?php echo($content["rate"]); ?></td>
                    <td class="tg-yw4l" style="text-align: right;"><?php echo($content["netkgs"]); ?></td>
                    <td class="tg-yw4l" style="text-align: right;"><?php 
                          $balance=$content["balance"];
                          $rate=$content["rate"];
                          $netkgs=$content["netkgs"];
                          $valuation=$balance*$netkgs*$rate;

                             echo number_format($valuation,2);
