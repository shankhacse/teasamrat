...
<div id="salebillDetails_0_<?php echo($divnumber); ?>" class="taxinvoicedetails">
            <table width="100%" class="gridtable">
                        <tr>
                            <td width="5%">
                                <input type="text" name="txtHSNNumber[]"  id="txtHSNNumber_0_<?php echo($divnumber); ?>" class="hsn" placeholder="HSN" style="width:50px;" readonly />
                            </td>
                        <td width="10%">
                        ...
                        <td width="5%">
							<input type="text" class="packet" id="txtDetailPacket_0_<?php echo($divnumber); ?>" name="txtDetailPacket[]" value="" placeholder="Packet"  style="width:50px;"/>
						</td>
                        <td width="5%">
							<input type="text" class="net" id="txtDetailNet_0_<?php echo($divnumber); ?>" name="txtDetailNet[]" value="" placeholder="Net(Kg)"  style="width:50px;" readonly />
						</td>
                        <td width="5%">
							<input type="text" class="pacQty" id="txtDetailQuantity_0_<?php echo($divnumber); ?>" name="txtDetailQuantity[]"  placeholder="Quantity(Kg)" readonly style="width:100px;"/>
						</td>
                        <td width="5%">
							<input type="text" class="rate" id="txtDetailRate_0_<?php echo($divnumber); ?>" name="txtDetailRate[]" placeholder="Rate" style="width:50px;"/>
						</td>
                        <td width="5%">
							<input type="text" class="amount" id="txtDetailAmount_0_<?php echo($divnumber); ?>" name="txtDetailAmount[]" placeholder="Amount" readonly style="width:140px;"/>
						</td>
                        <td width="5%">
						 ...
						 <td width="5%">
                            <input type="text" class="freight" id="txtFreight_0_<?php echo($divnumber); ?>" name="txtFreight[]" placeholder="Freight"  style="width:100px;"/>
                        </td>
                        <td width="5%">
