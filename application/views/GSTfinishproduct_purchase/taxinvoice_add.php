        ...
        <table width="100%" border="0" align="center" class="gridtable">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text"  id="txtSaleBillNo" name="txtSaleBillNo" class="salebillNo" style="width:300px;" value="<?php echo $bodycontent['taxInvoiceMaster']['purchasebillno']; ?>" <?php if($header['mode']=="Edit"){echo "readonly";}else{echo "";} ?> />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="saleBillDate" id="saleBillDate" class="datepicker" value="<?php
                    if ($bodycontent['taxInvoiceMaster']['purchasebilldate']) {
                        echo($bodycontent['taxInvoiceMaster']['purchasebilldate']);
                    } else {
                        echo $entryDt;
                    }
                ...
                <td>
					...
					<select id="vendor" name="vendor" class="vendor custom-select" style="width:300px;">
						...
						<?php foreach($header['vendor'] as $rows){?>
							<option value="<?php echo($rows['vendorId']); ?>" <?php if($bodycontent['taxInvoiceMaster']['vendorId']==$rows['vendorId']){echo "selected"; }else{echo "";}?>>
								<?php echo($rows['name']); ?>
							</option>
						<?php } ?>
					</select>
                    <p id="vendor_err" style="font-weight: 600;font-size: 13px;color:red;display:none;">Select Vendor</p>
				</td>
            </tr>
...
if ($bodycontent['taxInvoiceDetail']) {
    ...
    foreach ($bodycontent['taxInvoiceDetail'] as $content) {
                        ...
                        <tr>
                            <td>
                                <input type="text" name="txtHSNNumber[]" 
                                       ...
                                       class="hsn" placeholder="HSN"  value="<?php echo($content['HSN']); ?>" style="width:50px;" readonly />
                            </td>    
                            <td width="10%">
                                <select name="finalproduct[]" id="finalproduct_<?php echo($content['purchase_finishmasterId']); ?>_<?php echo($content['id']); ?>" style="width:250px;" class="finalProduct"> 
        ...
        <?php } ?>
                            ...
                            <td width="10%">
                                <input type="text" class="net" style="width:50px;" id="txtDetailNet_<?php echo($content['purchase_finishmasterId']); ?>_<?php echo($content['id']); ?>" name="txtDetailNet[]" value="<?php echo($content['packingnet']); ?>" placeholder="Net(Kg)" readonly/>
                            </td>
                            <td width="10%">
							...
							<td width="5%">
								<input type="text" class="freight" id="txtFreight_<?php echo($content['purchase_finishmasterId']); ?>_<?php echo($content['id']); ?>" name="txtFreight[]" placeholder="Freight"  value="<?php echo($content['freight']); ?>" style="width:100px;"/>
							</td>
                            <td width="5%">
    ...
    <section id="loginBox" style="width: 690px; height: 400px;">
        <table width="100%" border="0"   class="gridtable">
			...
			<tr>
                ...
                <td><label>Freight amount</label></td>
                <td><input type="text" id="txtFreightAmount" name="txtFreightAmount" style="background-color: #dedede"
                           value="<?php echo($bodycontent['taxInvoiceMaster']['GST_FreightAmt']); ?>" readonly="readonly"/></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
