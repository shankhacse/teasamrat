  ...
  <section id="loginBox" style="width:600px;">
    <table cellspacing="10" cellpadding="10" class="tablespace" >
      <tr>
        ...
        <td>
          <input type="text" class="datepicker textStyle" id="startdate" name="startdate" value="<?php echo date('d-m-Y',strtotime($header['fiscalStartDt'])); ?>"/ >
          <input type="hidden" name="startyear" id="startyear" value="<?php echo date('Y',strtotime($header['fiscalStartDt'])); ?>">
          <input type="hidden" name="endyear" id="endyear" value="<?php echo date('Y',strtotime($header['fiscalEndDt'])); ?>">
        </td>
        <td/>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" class="datepicker textStyle" id="enddate" name="enddate" value="<?php echo date('d-m-Y',strtotime($header['fiscalEndDt'])); ?>" />
        </td>
      </tr>
      <tr>
        <td scope="row">Vendor 
	  ...
	  <tr>
        ...
        <td>
         <input type="radio" name="billType" value="GST" checked> GST &nbsp;&nbsp;&nbsp;
		 <input type="radio" name="billType" value="NONGST"> Non-GST<br>
        </td>
      </tr>
	  
	  <tr>
		<td>&nbsp;</td>
		<td><p style="color:#218021;font-weight: 600;">Purchase Considered in this report  : Garden Tea Purchase  </p></td>
	</tr>
    </table>
    <br/>
