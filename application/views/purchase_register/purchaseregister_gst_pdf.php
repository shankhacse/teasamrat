        ...
        <table width="100%" class="demo">
            ...
            if ($search_purchase_register) {
                ...
                foreach ($search_purchase_register as $row) {
					...
					$pageTotalBag+=$row['bagDtl']['actualBag'];
					$pageTotalNet+=$row['bagDtl']['totalkgs'];
                    ...
                    <tr>
                        <td colspan="4" align="left"><b>Page Total</b></td>
                        <td align="right"><b><?php echo number_format($pageTotalBag,2);?></b></td>
                        <td align="right"><b><?php echo number_format($pageTotalNet,2);?></b></td>
					...
					$grandTotalBag+=$row['bagDtl']['actualBag'];
		        	$grandTotalNet+=$row['bagDtl']['totalkgs'];
            ...
            <?php } ?>
                ...
                <tr>
					 ...
					 <td align="right"><b><?php echo number_format($grandTotalBag,2); ?></b></td>
					 <td align="right"><b><?php echo number_format($grandTotalNet,2); ?></b></td>
