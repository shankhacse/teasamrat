                                           ...
                                           ?>
                                            <tr>
                                                ...
                                                <td>
                                                 ...
                                                 <td>
                                                    <input type="button" class="styled-button-10" value="update" id="stockupdatebtn_<?php echo($sl);?>"
                                                            onclick="updateRecvDo(<?php echo($content['doTransIds']);?>,<?php echo($sl);?>);" />

                                                  <img src="<?php echo base_url();?>application/assets/images/verify_logo.gif" alt="" id="stockupdloader_<?php echo($sl);?>" style="display: none;" /> 
                                                 </td>
