...
<form action="#" name="customerPaymentForm" id="customerPaymentForm">
<section id="loginBox" style="height: 350px;">
  ...
  <input type="hidden" id="mode" name="mode" value="<?php echo($header['mode']); ?>"/>
    ...
    <td>
      ...
      <input type="text" name="paymentdate" id="paymentdate" class="textStyle datepicker" value="<?php echo($bodycontent['customerpayment']['dateofpayment']); ?>"/>
      <?php }else{ ?>
        <input type="text" name="paymentdate" id="paymentdate" class="textStyle datepicker" value="<?php echo $entryDt; ?>"/>
      <?php } ?>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      <?php if($header['mode']=="Edit"){ ?>
        <input type="hidden" id="hidenChqno" value="<?php echo($bodycontent['customerpayment']['cheque_number']); ?>"/>
        <input type="hidden" id="hidenChqdate" value="<?php echo($bodycontent['customerpayment']['cheque_date']); ?>"/>

        <input type="text" name="chequedt" id="chequedt" class="textStyle chqdt" value="<?php echo($bodycontent['customerpayment']['cheque_date']); ?>"/>
      <?php }else{?>
        <input type="text" name="chequedt" id="chequedt" class="textStyle chqdt" value="<?php echo $entryDt; ?>"/>
      <?php } ?> 
    </td>
    <td>Customer&nbsp;</td>
    <td>
    ...
    <table id="billAdjustTable" width="60%" class="gridtable" align="center">
     <thead style="background-color:gray;">
      ...
      foreach ($bodycontent["customerPaymentDtl"] as $value) {
            ?>
               <tr>
              <td><?php echo($value["billNo"]); ?>
              <input type='hidden' name='customerBillMstId' value='<?php echo($value["customerBillMaster"]); ?>'/>
             <input type='hidden' name='custBillMasterIDS[]' value='<?php echo($value["customerBillMaster"]); ?>'/></td>
              ...
              <!-- <img src='<?php echo base_url(); ?>application/assets/images/delete-ab.png' alt='del' class='rowDel' style='cursor: pointer;' /> -->

      <img src='<?php echo base_url(); ?>application/assets/images/delete-ab.png' alt='del' 

      data-customerbillmastid="<?php echo($value["customerBillMaster"]); ?>" 
      data-customerreceiptdtlid="<?php echo($value["customerreceiptDtlId"]); ?>" 
      class='rowDel' style='cursor: pointer;' />
