<script src="<?php echo base_url(); ?>application/assets/js/customerPaymentOtherAdjAdd.js"></script>
...
<h2><font color="#5cb85c">Add customer's Bill Adj( TDS / Delivery...)</font></h2>
<?php }else{?>
<h2><font color="#5cb85c">Edit customer's Bill Adj( TDS / Delivery...)</font></h2>
<?php } ?>
...
<section id="loginBox" style="height: 350px;">
  ...
  <tr>
    <td><!-- Cash/Bank. --> A/C to be debited&nbsp;&nbsp;</td>
    <td> <!--Commented on 04.05.2018 by shankha -->
