<script src="<?php echo base_url(); ?>application/assets/js/customerpayment.js"></script> 
 ...
 <h2><font color="#5cb85c">Customer Receipt Bill Adj.(TDS/Delivery Charge...)</font></h2>
 <div class="stats">
 
    <p class="stat">
        <a href="<?php echo base_url(); ?>customerpaymentotheradj/addCustomerPayment" class="showtooltip" title="add">
       ...
       <?php 
        ...
        <tr>
            ...
            <td style="text-align:right;"> 
                <a href="<?php echo base_url(); ?>customerpaymentotheradj/addCustomerPayment/id/<?php echo($content['customerpaymentid']); ?>" class="showtooltip" title="Edit">
