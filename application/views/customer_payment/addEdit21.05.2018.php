...
<section id="loginBox" style="height: 350px;">
  ...
  <input type="hidden" id="mode" name="mode" value="<?php echo($header['mode']); ?>"/>
    ...
    <td>
      ...
      <?php }else{ ?>
        <input type="text" name="paymentdate" id="paymentdate" class="textStyle datepicker" value="<?php echo date("d-m-Y"); ?>"/>
      <?php } ?>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      ...
      <?php }else{?>
        <input type="text" name="chequedt" id="chequedt" class="textStyle chqdt" value="<?php echo date("d-m-Y"); ?>"/>
      <?php } ?> 
    </td>
    <td>Customer&nbsp;</td>
    <td>
