    ...
    <section id="loginBox" style="height: 400px;">
        <table width="100%" border="0" align="center" class="gridtable">
			...
			<tr>
				 ...
				 <td>
					<?php if($header['mode']=="Add"){?>
						<select name="placeofsupply" id="placeofsupply" class="custom-select">
					...
					<?php }else{ ?>
						...
						<select name="placeofsupply" id="placeofsupply" class="custom-select">
							<?php foreach($header['statelist'] as $state_list)
							{?>
								<option value="<?php echo $state_list['state_code'];?>" <?php if($state_list['state_code']==$bodycontent['taxInvoiceMaster']['state_code']){echo "selected";}else{echo "";}?>><?php echo $state_list['state_name']; ?></option>
							<?php } ?>
						</select>
            ...
            <tr>
                ...
                <td id="customer_td">
                    ...
                    <select id="customer" name="customer" class="customer custom-select" style="width:300px;"  onchange="getConsignee(this.value);">
...
<?php } ?>
                ...
                <td id="consignee_td">
                    ...
                    <select id="sel_consignee" name="sel_consignee" class="customer custom-select" style="width:300px;">
                      <option value="">Select</option>    


                            <?php if ($header['mode'] == "Edit") {
                       foreach ($header['consigneetList'] as $rows) {
                 
                  ?> 
                 
                 <option value="<?php echo $rows->id; ?>"
                     <?php if($bodycontent['taxInvoiceMaster']['consignee_id']==$rows->id){echo('selected');}else{echo('');} ?>
                    ><?php echo $rows->consignee_name; ?></option>
                 <?php
                    } 
                  }?> 
        ...
        <tr>
			...
			<tr>
                ...
                <td colspan="2" style="text-align: center">
                    <button type="button" class="btn btn-primary" id="addnewDtlDiv" style="background:#0e603b;font-size:13px;" >Add Details</button>
                </td>
    ...
    <section id="loginBox" class="salebillDtl" style="background:#f7f7f7;">
<?php
                        ...
                        <tr>
                            <td>
                                <input type="text" name="txtHSNNumber[]" 
                                       ...
                                       class="hsn" placeholder="HSN"  value="<?php echo($content['HSN']); ?>" style="width:50px;" title="HSN" readonly />
                            </td>    
                            <td width="30%">
                                <select name="finalproduct[]" id="finalproduct_<?php echo($content['salebillmasterid']); ?>_<?php echo($content['saleBillDetailId']); ?>" style="width:250px;" class="finalProduct"> 
                            ...
                            <td width="10%">
                                <input type="text" class="packet" style="width:50px;" id="txtDetailPacket_<?php echo($content['salebillmasterid']); ?>_<?php echo($content['saleBillDetailId']); ?>" name="txtDetailPacket[]" value="<?php echo($content['packingbox']); ?>" placeholder="Packet" title="Packet"/>
                            </td>
                            <td width="10%">
                                <input type="text" class="net" style="width:50px;" id="txtDetailNet_<?php echo($content['salebillmasterid']); ?>_<?php echo($content['saleBillDetailId']); ?>" name="txtDetailNet[]" value="<?php echo($content['packingnet']); ?>" placeholder="Net(Kg)" title="Net(Kg)"/>
                            </td>
                            <td width="10%">
                                <input type="text" style="width:100px;" class="pacQty" id="txtDetailQuantity_<?php echo($content['salebillmasterid']); ?>_<?php echo($content['saleBillDetailId']); ?>" name="txtDetailQuantity[]" value="<?php echo($content['quantity']); ?>" placeholder="Quantity(Kg)" readonly title="Quantity(Kg)"/>
                            </td>
                            <td width="10%">
                                <input type="text" style="width:50px;" class="rate" id="txtDetailRate_<?php echo($content['salebillmasterid']); ?>_<?php echo($content['saleBillDetailId']); ?>" name="txtDetailRate[]" value="<?php echo($content['rate']); ?>" placeholder="Rate" title="Rate" />
                            </td>
                            <td width="10%">
                                <input type="text" style="width:140px;" class="amount" id="txtDetailAmount_<?php echo($content['salebillmasterid']); ?>_<?php echo($content['saleBillDetailId']); ?>" name="txtDetailAmount[]" value="<?php echo($content['amount']); ?>" placeholder="Amount" readonly title="Amount" />
                            </td>
                            ...
                            <!--GST SECTION added -->
                            <td width="5%">
                                <input type="text" class="discrate" id="txtDiscountRate_<?php echo($content['salebillmasterid']); ?>_<?php echo($content['saleBillDetailId']); ?>" 
                                       name="txtDiscountRate[]" 
                                       value="<?php echo($content['discount_rate']); ?>"
                                       placeholder="Disc. Rate"  style="width:100px;" title="Disc. Rate" />
                            </td>
							 <td width="5%">
                                <input type="text" class="discount" id="txtDiscount_<?php echo($content['salebillmasterid']); ?>_<?php echo($content['saleBillDetailId']); ?>" 
                                       ...
                                       placeholder="Discount"  style="width:100px;" readonly title="Discount" />
                            </td>
                            <td width="5%">
                                <input type="text" class="deliverycharge" id="txtDelivery_<?php echo($content['salebillmasterid']); ?>_<?php echo($content['saleBillDetailId']); ?>" 
                                       name="txtDelivery[]" 
                                       value="<?php echo($content['delivery_charge']); ?>"
                                       placeholder="Delivery Charge"  style="width:100px;"  onKeyUp="numericFilter(this);" title="Delivery Charge" />
                            </td>
                            <td width="5%">
                                <input type="text" class="taxableamount"
                                       ...
                                       placeholder="Taxable" readonly="" style="width:100px;" title="Taxable"  />
                            </td>
...
?>
	...
	<div id="sale_bil_upd_dilg"  style="display:none" title="Taxinvoice">
