...
<table width="100%" border="0" class="demo" style="border-top:0;">
    <tr>
		...
		$totalDeliveryCharg+= $value['delivery_charge'];
        ...
        <tr>
            ...
            <td align="right"><?php echo($value['delivery_charge']);?></td>
...
<table width="100%" border="0" class="demo" style="border-top:0;">
    ...
    <?php } ?>
        ...
        <td align="right"><b><?php echo(number_format($totalDeliveryCharg,2)); ?></b></td>
...
<table width="100%" class="headerdemo" border="0" style="border-top:0;font-size:11px;" cellspacing="8" cellpadding="0">
	...
	<tr style="height:25px;">
		...
		<br><br>
			...
			<?php echo $companyinfo->bank_name; ?> A/C NO - <?php echo $companyinfo->bank_ac_no; ?><br>
			IFSC CODE - <?php echo $companyinfo->ifsc_code; ?><br>
			BRANCH - <?php echo $companyinfo->bank_branch_add; ?>
