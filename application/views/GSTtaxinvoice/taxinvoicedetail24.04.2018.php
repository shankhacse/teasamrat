...
<div id="salebillDetails_0_<?php echo($divnumber); ?>" class="taxinvoicedetails">
            <table width="100%" class="gridtable">
						...
						<td width="5%">
							<!-- Discount rate -->
                            <input type="text" class="discrate" id="txtDiscountRate_0_<?php echo($divnumber); ?>" name="txtDiscountRate[]" placeholder="Disc. Rate"  style="width:100px;"/>
                        </td>
                        <td width="5%">
                            <input type="text" class="discount" id="txtDiscount_0_<?php echo($divnumber); ?>" name="txtDiscount[]" placeholder="Discount"  style="width:100px;" readonly />
                        </td>
                        <td width="5%">
