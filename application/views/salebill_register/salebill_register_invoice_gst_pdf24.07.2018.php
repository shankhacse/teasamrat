        ...
        <table  class="demo" width="100%">
            ...
            if ($resultSalebill) {
                ...
                foreach ($resultSalebill as $row) {
                   ...
                   // $totalQtySum+= $totalQtySum+$row['totalQty'];
                    $totalCGSTSum+= $row['cgstamount'];
                    $totalSGSTSum+= $row['sgstamount'];
                    $totalIGSTSum+= $row['igstamount'];
                    $totalDiscountSum+= $row['discountAmount'];
            ...
            <?php } ?>
			 <tr>
                <td colspan="5" style="font-size:12px;font-weight:bold;">Grand Total </td>
