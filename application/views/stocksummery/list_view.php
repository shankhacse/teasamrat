     ...
     <tbody>
         ...
         <?php 
            ...
            if(count($stock) > 0)
			{
                ...
                <tr id="row">
					<td>
                       <strong> <?php echo "Group -> ".$content['Group']; ?></strong>
					</td>
                    <td width="10%" style="text-align:left;" align="left"><?php echo $content['Location']; ?> </td> 
                    <td>
                    ...
                    <td align="right"><?php echo $content['amount']; ?> </td>
                </tr>
				<?php }else {echo "";}?>
...
$(document).ready(function() {
	...
	*/
	...
	//var totalSum = table.column( 12 ).data().sum();
