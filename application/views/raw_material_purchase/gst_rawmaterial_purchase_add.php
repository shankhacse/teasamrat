...
<table width="100%" border="0">
 <tr>
  ...
  <tr>
    ...
    <td>
      <input type="text"  id="invoiceno" name="invoiceno" class="textStyle" value="<?php echo $bodycontent['rawpurchaseMaster']['invoice_no'];?>"/>
      <input type="hidden"  id="oldinvoiceno" name="oldinvoiceno" class="textStyle" value="<?php 
      if($header['mode']=="Edit"){
      echo $bodycontent['rawpurchaseMaster']['invoice_no'];
      }else{echo "";}
    ...
    if($bodycontent['rawpurchaseMaster']['Invoicedate']){echo $bodycontent['rawpurchaseMaster']['Invoicedate'];}else{echo $entryDt;}
    ?>" /></td>
  </tr>
  <tr><td colspan="5">&nbsp;</td></tr>
  <tr>
   ...
   <tr>
    ...
    <td>
      <input type="hidden"  id="oldvendor" name="oldvendor" class="textStyle" value="<?php 
        if($header['mode']=="Edit"){
      echo $bodycontent['rawpurchaseMaster']['vendor_id'];}else{echo "";}
      ?>"/>
...
<section id="loginBox" class="rawmaterialDtlview">
    ...
    <div id="rawmaterialDetails_<?php echo($content['rawPurchMastid']);?>_<?php echo($content['rawPurDtlId']); ?>" class="rawmaterialdetails">
            <table width="100%" class="gridtable">
                        ...
                        <select class="productlist" name="productlist[]" id="productlist_<?php echo($content['rawPurchMastid']);?>_<?php echo($content['rawPurDtlId']); ?>" style="width:175px;"> 
...
<div class="row">
            ...
            <div class="col-sm-8">
              <p class="invoice-validation-err " style="color: red;"></p>
            </div>
          </div>
