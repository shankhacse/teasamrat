        ...
        <table width="80%" border="0" align="center" class="">
            ...
            <tr>
                ...
                <td>
                    <?php 
                    if($header['mode']=="Edit"){ ?>
                      <input type="hidden" id="hidenChqno"  value="<?php echo($bodycontent['customeradvance']['cheque_number']);?>"/>
                      <input type="hidden" id="hidenChqdate" value="<?php echo($bodycontent['customeradvance']['cheque_date']);?>"/>
            ...
            <tr>
             ...
             <tr>
               ...
               <input type="hidden" id="payment_type_hidden" name="payment_type_hidden" value="<?php if($header['mode']=="Edit"){ 
                                    echo $bodycontent['customeradvance']['payment_type'];
                        }else{ echo "";}?>"> 

                 <input type="radio" id="payment_type_a" name="payment_type" value="RC" 

                 <?php if($header['mode']=="Edit"){ 

                    if($bodycontent['customeradvance']['payment_type']=="RC")
                      {
                        echo "checked";
                      }else{echo "";} 
                   }else{ echo "checked";}?>> Receipt &nbsp;&nbsp;  


                 <input type="radio" id="payment_type_b" name="payment_type" value="PY" 
                  <?php if($header['mode']=="Edit"){ 

                                 if($bodycontent['customeradvance']['payment_type']=="PY")
                                 {
                                    echo "checked";
                                 }else{
                                    echo "";
           ...
           <tr>
            ...
            <tr>
               ...
               <tr>
                <td >&nbsp;</td>
                <td colspan="2"><span class="customer-adjusment-validation-err" style="color: red;"></span></td>
            </tr>
              <tr>
                <td colspan="3">&nbsp;</td>
            </tr>
