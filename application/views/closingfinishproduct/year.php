...
<h2><font color="#5cb85c">Finish Product Stock transfer</font></h2>
<section id="loginBox" style="height: 70px;">
  ...
  <tr>
    ...
    <td>
        ...
        <img src="<?php echo base_url(); ?>application/assets/images/folder_arrow_right_move_send.png " id="transferfinishproduct" style="cursor: pointer;"/>
        <?php } ?>
    </td>
    <td>&nbsp;</td>
  </tr>
