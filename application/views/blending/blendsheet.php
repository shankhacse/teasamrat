        ...
        Please Blend the undernoted Teas on our A/C and lift them after blending ,into the old bags ready for packing.Packing instruction shall follow soon.
            ...
            <table  >
                <tr>
                    ...
                    <td align="right">Net in Kg(s)</td>
                    <td align="right">Qty in Kg(s)</td>
                    ...
                    if($noofbag==0){echo "";}else{
                        ...
                        <tr>
                           ...
                           <td width="4%"><?php echo $j++; ?></td>
                            <td style="width:10%;"><?php echo $value['Location']; ?></td>
                            <td style="width:12%;"><?php echo $value['Lot']; ?></td>
                            <td style="width:15%;"><?php echo $value['Garden']; ?></td>
                            <td style="width:12%;"><?php echo $value['Invoice']; ?></td>
                            <td  style="width:12%;"><?php echo $value['Grade']; ?></td>
                            <!--<td><?php echo $value['Group']; ?></td>-->
                            <td align="right" style="width:8%;"><?php echo $value['PackingBag']; ?></td>
                            <td align="right" style="width:8%;"><?php echo $value['QtyKgs']; ?></td>
                            <td align="right" style="width:8%;"><?php echo $value['BlendQty']; ?></td>
                         </tr>
